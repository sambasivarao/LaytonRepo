...
public partial class ProblemInfo : System.Web.UI.Page
{
    ...
    public RadEditor edtCause = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            SaveQueryStr();
            Session["ButtonBack"] = "ProblemInfo.aspx?sys_problem_id=" + ViewState["sys_problem_id"];
    ...
    private void MyInit()
    {
        ...
        if (ViewState["sys_problem_id"] != null)
        {
            strProblemId = ViewState["sys_problem_id"].ToString();
        }

        if (htOpenStatus == null)
        {
            htOpenStatus = new Hashtable();
            DataSet dsOpenStatus = ProblemDA.GetOpenStatus();
            if (dsOpenStatus != null && dsOpenStatus.Tables.Count > 0)
            {
                foreach (DataRow dr in dsOpenStatus.Tables[0].Rows)
                {
                    htOpenStatus.Add(dr["sys_problem_status_ID"].ToString(), "true");
                }
            }
        ...
        if (strProblemId != "")
        {
            DataSet dsProblem = ProblemDA.GetProblemFullInfoById(strProblemId);

            if (dsProblem == null || dsProblem.Tables.Count <= 0 || dsProblem.Tables[0].Rows.Count <= 0)
            {
                ShowMsg("Couldn't find this Problem");
                return;
            }

            string strStatus = dsProblem.Tables[0].Rows[0]["sys_problem_status"].ToString();

            if (htOpenStatus[strStatus] == null && Application["applockusercloseproblem"].ToString() == "true")
            {
                bAllowChange = false;
        ...
        string strXml = "";
        if (FormDesignerDA.ExistUserProblemForm(Session["User"].ToString()))
        {
            DataSet dsFormXml = FormDesignerDA.GetUserProblemForm(Session["User"].ToString());
            strXml = dsFormXml.Tables[0].Rows[0]["formxml"].ToString();
        }
        else
        {
            strXml = FormDesignerDA.LoadFormXMLFromDB("problem");
        }
        ...
        if (dsStatus != null && dsStatus.Tables.Count > 0)
        {
            ...
            {
                htStatus.Add(dr["sys_problem_status_id"].ToString(), dr["sys_problem_status"].ToString());
            }
        }
        ...
        if (ViewState["sys_problem_id"] != null && ViewState["sys_problem_id"].ToString() != "")
        {
            LoadVal();

            LoadSus("", GetValue("sys_problem_id"), GetValue("sys_problemdate"));
        }
    ...
    private void LoadVal()
    {
            ...
            if (strDispTbl != "" && strDispTbl != strTbl)
            {
                ...
                if (node.InnerText == "sys_forename")
                {
                    if (strDispTbl == "user")
                    {
                        ...
                        else if (strLink == "sys_loggedby")
                        {
                            strAsField = "loggedby_forename";
                        }
                    }
                }
        ...
        if (ViewState["sys_problem_id"] == null || ViewState["sys_problem_id"].ToString() == "")
        {
            strSql += " WHERE sys_problem_id = Null";
        }
        else
        {
            strSql += " WHERE sys_problem_id='" + ViewState["sys_problem_id"].ToString().Replace("'", "''") + "'";
        }
        ...
        foreach (XmlElement child in xmlForm.DocumentElement.ChildNodes)
        {
            ...
            else if (child.Name.Length >= 5 && child.Name.Substring(0, 5).ToLower() == "sys_b")
            {
                ...
                else if (child.Name == "sys_button2")
                {
                    ...
                    {
                        ctrl.OnClientClick = "CheckAllowed(this);document.location='" + "ProblemChgStatus.aspx?sys_problem_id=" + ViewState["sys_problem_id"] + "'; return false;";
                    }
                ...
                else if (child.Name == "sys_button3")
                {
                    ...
                    int nCnt = 0;
                    if (ViewState["sys_problem_id"].ToString() != "")
                    {
                        nCnt = ProblemDA.GetProblemTaskCnt(ViewState["sys_problem_id"].ToString());
                        if (nCnt > 0)
                        {
                    ...
                    {
                        ctrl.OnClientClick = "CheckAllowed(this);document.location='" + "UserTask.aspx?sys_problem_id=" + ViewState["sys_problem_id"] + "'; return false;";
                    }
                ...
                else if (child.Name == "sys_button5")
                {
                    ...
                    {
                        ctrl.OnClientClick = "CheckAllowed(this);document.location='" + "ProblemHistory.aspx?sys_problem_id=" + ViewState["sys_problem_id"] + "';return false;";
                    }
                ...
                else if (child.Name == "sys_button6")
                {
                    //Attachment
                    string strImg = child.GetAttribute("image");
                    int nCnt = ProblemDA.GetProblemAttchCnt(ViewState["sys_problem_id"].ToString());
                    ...
                    {
                        ctrl.OnClientClick = "CheckAllowed(this);document.location='" + "ProblemAttach.aspx?sys_problem_id=" + ViewState["sys_problem_id"] + "'; return false;";
                    }
                ...
                else if (child.Name == "sys_button7")
                {
                    ...
                    else
                    {
                        ...
                        if (ViewState["sys_problem_id"].ToString() != "")
                        {
                            ...
                            nCnt = ProblemDA.GetCommentCntByProblemId(ViewState["sys_problem_id"].ToString());
                            nReadCnt = ProblemDA.GetCommentReadCntByUserProblemId(ViewState["sys_problem_id"].ToString(), Session["User"].ToString());
                        ...
                        {
                            ctrl.OnClientClick = "CheckAllowed(this);document.location='" + "ProblemComment.aspx?sys_problem_id=" + ViewState["sys_problem_id"] + "'; return false;";
                        }
                ...
                else if (child.Name == "sys_button12")
                {
                    ...
                    {
                        ctrl.OnClientClick = "CheckAllowed(this);document.location='" + "ProblemCallback.aspx?sys_problem_id=" + ViewState["sys_problem_id"] + "'; return false;";
                    }
                ...
                else if (child.Name == "sys_button13")
                {
                    ...
                    {
                        ctrl.OnClientClick = "CheckAllowed(this);document.location='" + "ProblemCost.aspx?sys_problem_id=" + ViewState["sys_problem_id"] + "'; return false;";
                    }
                ...
                else if (child.Name == "sys_button14")
                {
                    ...
                    {
                        ctrl.OnClientClick = "CheckAllowed(this);document.location='" + "ProblemLink.aspx?sys_problem_id=" + ViewState["sys_problem_id"] + "'; return false;";
                    }
                ...
                else if (child.Name == "sys_button16")
                {
                    ...
                    {
                        ctrl.OnClientClick = "CheckAllowed(this);document.location='" + "ChangeInfo.aspx?newfromproblem=" + ViewState["sys_problem_id"] + "'; return false;";
                    }
            ...
            else
            {
                ...
                {
                    if (child.InnerText == "sys_problem_description" || child.InnerText == "sys_problem_cause" || child.InnerText == "sys_problem_solution")
                    {
                        string strShowOnTab = LayUtil.GetAttribute(child, "ontab");
                        if (strShowOnTab == "true")
                        {
                    ...
                    if (child.InnerText == "sys_problem_id")
                    {
                        //Create Textbox
                        TextBox ctrl = new TextBox();
                        ctrl.Text = strVal;
                    ...
                    else if (child.InnerText == "sys_problemdate")
                    {
                        string strWidth = child.GetAttribute("width");
                        if (!LayUtil.IsNumeric(strWidth))
                        {
                    ...
                    else if (child.InnerText == "sys_problem_closedate")
                    {
                        string strWidth = child.GetAttribute("width");
                        if (!LayUtil.IsNumeric(strWidth))
                        {
                    ...
                    else if (child.InnerText == "sys_assetsaffected")
                    {
                        ...
                        //if (!IsPostBack)
                        {
                            if (LayUtil.IsNumeric(ViewState["sys_problem_id"].ToString()))
                            {
                                DataSet dsItem = ProblemDA.GetAssets(ViewState["sys_problem_id"].ToString());
                    ...
                    else if (child.InnerText == "sys_itservice")
                    {
                        ...
                        //if (!IsPostBack)
                        {
                            if (LayUtil.IsNumeric(ViewState["sys_problem_id"].ToString()))
                            {
                                DataSet dsSvsItem = ProblemDA.GetItServices(ViewState["sys_problem_id"].ToString());
                        ...
                        if (!UserReadOnly(child))
                        {
                            //Create Select image
                            HyperLink hl = new HyperLink();
                            hl.NavigateUrl = "javascript:selitservice('" + ctrl.ClientID + "','problem" + ViewState["sys_problem_id"] + "');";
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            /*
                            if (child.InnerText == "sys_problem_description")
                            {
    ...
    private string GetUserInputDD(string strField)
    {
        if (bRule)
        {
            ...
            if (strField == "sys_priority" && htCtrl["sys_priority"] != null && ViewState["sys_problem_id"].ToString() != "" && SysDA.GetSettingValue("apppopupwhenprioritychange", Application) == "true")
            {
                //not apply BR
            }
            else
    ...
    private string GetUserInput(XmlElement child)
    {
        ...
        else
        {
            if (child.Name.Length >= 4 && child.Name.Substring(0, 4).ToLower() == "sys_")
            {
                ...
                else if (child.InnerText == "sys_impact" || child.InnerText == "sys_urgency")
                {
                    WebDropDown ctrl = (WebDropDown)ctrlRoot.FindControl("dd" + child.Name);
                    if (ctrl != null && ctrl.SelectedItem != null)
                    {
    ...
    private bool CheckInput()
    {
        ...
        foreach (XmlElement child in xmlForm.DocumentElement.ChildNodes)
        {
            ...
            if (strType == "Integer")
            {
                if (child.InnerText == "sys_problem_timespent")
                {
                ...
                else if (strVal != "" && child.InnerText != "sys_problem_id")
                {
                    if (!LayUtil.IsNumeric(strVal))
                    {
    ...
    private SqlCommand GetInsCmd()
    {
        ...
        */
        ...
        strSql = "INSERT INTO problem(sys_problem_status";
        string strSqlVal = " VALUES(" + Application["appdefaultstatusproblem"].ToString();
        foreach (XmlElement child in xmlForm.DocumentElement.ChildNodes)
        {
            if (child.InnerText == "sys_problem_id" || child.InnerText == "sys_itservice" || child.InnerText == "sys_assetsaffected")
                continue;
            ...
            string strVal = GetUserInput(child);
            if (child.InnerText == "sys_problem_timespent" && strVal != "")
            {
            ...
            if ((child.Name.Length >= 9 && child.Name.Substring(0, 9) == "sys_field") || (child.Name.Length >= 5 && child.Name.Substring(0, 5) == "field"))
            {
                ...
                else
                {
                    ...
                    if (child.InnerText == "sys_problemdate" || child.InnerText == "sys_problem_closedate" || htCols[child.InnerText].ToString() == "DateTime")
                    {
        ...
        {
            string strVal = SysDA.GetSettingValue("appdefaulturgencyproblem", Application);
        ...
        {
            string strVal = SysDA.GetSettingValue("appdefaultimpactproblem", Application);
        ...
        string strPriority = "";
        if (htCtrl["sys_priority"] == null)
        {
            if (htCtrl["sys_requesttype_id"] == null || sys_requesttype_idH.Text == "")
            {
                strPriority = Application["appdefaultpriority"].ToString();
            }
            else
            {
                DataSet dsReqType = LibReqTypeDA.GetReqTypeInfo(sys_requesttype_idH.Text);
            ...
            {
                strSql += ", [sys_priority]";
                strSqlVal += ",@sys_priority";

                parameter = new SqlParameter();
                parameter.ParameterName = "@sys_priority";
                parameter.Direction = ParameterDirection.Input;
        ...
        {
            strPriority = GetUserInputDD("sys_priority");
        }
    ...
    private SqlCommand GetUpdCmd()
    {
        ...
        else
        {
            ...
            if (strPriority == "")
            {
                strSql += ", [sys_priority]=NULL";
            }
            else
            {
                strSql += ", [sys_priority]=@sys_priority";
        ...
        string strOldPriority = GetValue("sys_priority");
        if (!bPriorityEdit && strOldPriority != strPriority)
        {
            ...
            if ((dReqReslvHr != 0 || dReqEsc1Hr != 0 || dReqEsc2Hr != 0 || dReqEsc3Hr != 0 || dReqResHr != 0) && strBegin != "")
            {
                ...
                if (strSiteId != GetValue("sys_siteid") || DateTime.Compare(dtBegin, dtOrgBegin) != 0)
                {
                    LoadSus("", GetValue("sys_problem_id"), strSiteId, strBegin);
                }
                ...
                if (dReqResHr != 0)
                {
                    ...
                    if (strTime != "")
                    {
                        strSql += ", [sys_respond]=@sys_respond";
        ...
        strSql += " WHERE [sys_problem_id]=@sys_problem_id";
        parameter = new SqlParameter();
        parameter.ParameterName = "@sys_problem_id";
        parameter.Direction = ParameterDirection.Input;
        parameter.Value = ViewState["sys_problem_id"].ToString();
        cmd.Parameters.Add(parameter);
    ...
    private bool SaveData()
    {
        ...
        if (ViewState["sys_problem_id"] != null)
        {
            strOldPK = ViewState["sys_problem_id"].ToString();
        }
        ...
        {
            string strProblemId = ProblemDA.GetMaxProblemId();
            string strReqId = ViewState["newfromreq"].ToString();
            RequestDA.DeLinkReq2Problem(strReqId, strProblemId);
            RequestDA.LinkReq2Problem(strReqId, strProblemId);
        }
    ...
    private bool SaveItService()
    {
        ...
        if (strProblemId == "")
        {
            strProblemId = ProblemDA.GetMaxProblemId();
        }
        else
        {
            ProblemDA.ClearItServices(strProblemId);
        }
        ...
        if (lb != null)
        {
            ...
            {
                ProblemDA.InsItServices(strProblemId, lb.Items[i].Value);
            }
        }
    ...
    private bool SaveAssets()
    {
        ...
        {
            strProblemId = ProblemDA.GetMaxProblemId();
            strItemId = strProblemId;
        }
        else
        {
            strItemId = strProblemId;
            ProblemDA.ClearAssets(strItemId);
        }
        ...
        if (lb != null)
        {
            for (int i = 0; i < lb.Items.Count; i++)
            {
                ProblemDA.InsAssets(strItemId, lb.Items[i].Text, lb.Items[i].Value);
            }
        }
    ...
    /// <summary>
    /// Process the problem after save data
    /// </summary>
    private bool ProcessUpdProblem()
    {
        //Indicate if its new request
        bool bProblemNew = false;
        string strProblemId = "";
        if (ViewState["sys_problem_id"] != null)
        {
            strProblemId = ViewState["sys_problem_id"].ToString();
        ...
        if (strProblemId == "")
        {
            ...
            strProblemId = ProblemDA.GetMaxProblemId();
            ViewState["sys_problem_id"] = strProblemId;

            if (ProblemDA.ProblemInSus(strProblemId))
            {
                ProblemDA.ProblemInsertSus(strProblemId, GetUserInputDate("sys_problemdate"), Session["User"].ToString());

                ProblemDA.UpdProblemEsc(strProblemId);
            }
        }
        ...
        if (!bProblemNew)
        {
            foreach (XmlElement child in xmlForm.DocumentElement.ChildNodes)
            {
                ...
                if (child.InnerText == "sys_problem_hdmins" || child.InnerText == "sys_problem_24mins" || child.InnerText == "sys_problem_timespent")
                {
                    continue;
                }
                ...
                if (strOrgVal != strNewVal)
                {
                    ...
                    ProblemDA.InsProblemAudit(strProblemId, DateTime.Now, Session["User"].ToString(), "'Edited'", child.InnerText, strOrgVal, strNewVal);
                }
            }
        }
        else
        {
            foreach (XmlElement child in xmlForm.DocumentElement.ChildNodes)
            {
                ...
                ProblemDA.InsProblemAudit(strProblemId, DateTime.Now, Session["User"].ToString(), "'Created'", child.InnerText, strOrgVal, strNewVal);
            }
        }
        ...
        */
        ...
        if (strOrgAssignedTo != strNewAssignedTo || strOrgAssignedToGrp != strNewAssignedToGrp)
        {
            ...
            */
            ...
            if (SysDA.GetSettingValue("appemailproblemassignuserflag", Application) == "true")
            {
                if (strOrgAssignedTo != strNewAssignedTo)
                {
                    ...
                    if (dsNewUser != null && dsNewUser.Tables.Count > 0 && dsNewUser.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (strUserEmail != "")
                        {
                            ...
                            if (SysDA.GetSettingValue("appemailproblemassignuserflagsignature", Application) == "true")
                            {
                                strSignatureUser = Session["User"].ToString();
                            }

                            LayUtil.SendOutEmail(Application, "problem_assign_user", strUserEmail, strNewAssignedTo, "", "problem", strProblemId, "", ProblemDA.GetProblemMailCmd(strProblemId), strSignatureUser);
                        }
                    }
                }
            }

            if (SysDA.GetSettingValue("appemailproblemassignusergroupflag", Application) == "true")
            {
                if (strOrgAssignedToGrp != strNewAssignedToGrp)
                {
                    string strGrpEmail = "";
                    DataSet dsGrp;
                    if (SysDA.GetSettingValue("appemailproblemassignusergroupflag", Application) == "true" && strNewAssignedTo == "")
                    {
                    ...
                    if (dsGrp != null && dsGrp.Tables.Count > 0 && dsGrp.Tables[0].Rows.Count > 0)
                    {
                        foreach (DataRow drGrp in dsGrp.Tables[0].Rows)
                        {
                            ...
                            if (strGrpEmail != "")
                            {
                                LayUtil.SendOutEmail(Application,"problem_assign_usergroup", strGrpEmail, drGrp["sys_username"].ToString(),"","problem", strProblemId, "", ProblemDA.GetProblemMailCmd(strProblemId));
                            }
                        }
                    }
        ...
        {
            if (ProblemDA.CopyAttachFrmMail(strMailId, strProblemId))
            {
    ...
    {
        string strURL = "";
        if (LayUtil.IsNumeric(ViewState["sys_mail_id"].ToString()))
        {
        ...
        else
        {
            if (ViewState["from"].ToString() != "")
            {
                ...
                {
                    strURL = Session["ProblemList"].ToString();
                }
            }
            else if (Session["ProblemList"] != null)
            {
                strURL = Session["ProblemList"].ToString();
            }
            else
            {
                strURL = "UserProblem.aspx?user=" + Session["User"].ToString();
            }
        }
        return strURL;
    }
    ...
    protected void sys_button2_Click(object sender, ImageClickEventArgs e)
    {
        if (SaveProblemData())
        {
            ViewState["PostConfirmURL"] = "ProblemChgStatus.aspx?sys_problem_id=" + ViewState["sys_problem_id"];
    ...
    protected void sys_button3_Click(object sender, ImageClickEventArgs e)
    {
        if (SaveProblemData())
        {
            ViewState["PostConfirmURL"] = "UserTask.aspx?sys_problem_id=" + ViewState["sys_problem_id"];
    ...
    protected void sys_button5_Click(object sender, ImageClickEventArgs e)
    {
        if (SaveProblemData())
        {
            ViewState["PostConfirmURL"] = "ProblemHistory.aspx?sys_problem_id=" + ViewState["sys_problem_id"];
    ...
    protected void sys_button6_Click(object sender, ImageClickEventArgs e)
    {
        if (SaveProblemData())
        {
            ViewState["PostConfirmURL"] = "ProblemAttach.aspx?sys_problem_id=" + ViewState["sys_problem_id"];
    ...
    protected void sys_button7_Click(object sender, ImageClickEventArgs e)
    {
        if (SaveProblemData())
        {
            ViewState["PostConfirmURL"] = "ProblemComment.aspx?sys_problem_id=" + ViewState["sys_problem_id"];
    ...
    protected void sys_button10_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            Response.Redirect("ReqCopy.aspx?sys_request_id=" + ViewState["sys_request_id"]);
        }
    }
    ...
    protected void sys_button11_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            Response.Redirect("ReqChgClass.aspx?sys_request_id=" + ViewState["sys_request_id"]);
        }
    }
    ...
    protected void sys_button12_Click(object sender, ImageClickEventArgs e)
    {
        if (SaveProblemData())
        {
            ViewState["PostConfirmURL"] = "ProblemCallback.aspx?sys_problem_id=" + ViewState["sys_problem_id"];
    ...
    protected void sys_button13_Click(object sender, ImageClickEventArgs e)
    {
        if (SaveProblemData())
        {
            ViewState["PostConfirmURL"] = "ProblemCost.aspx?sys_problem_id=" + ViewState["sys_problem_id"];
    ...
    protected void sys_button14_Click(object sender, ImageClickEventArgs e)
    {
        if (SaveProblemData())
        {
            ViewState["PostConfirmURL"] = "ProblemLink.aspx?sys_problem_id=" + ViewState["sys_problem_id"];
    ...
    protected void sys_button16_Click(object sender, ImageClickEventArgs e)
    {
        if (SaveProblemData())
        {
            ViewState["PostConfirmURL"] = "ChangeInfo.aspx?newfromproblem=" + ViewState["sys_problem_id"];
    ...
    private bool LoadMailVal()
    {
        ...
        if (dsMailIn != null && dsMailIn.Tables.Count > 0 && dsMailIn.Tables[0].Rows.Count > 0)
        {
            ...
            htMailVal.Add("sys_problem_summary", strSub);
            htMailVal.Add("sys_problem_description", strProblemDesc);
            ...
            */
            ...
            if (strDate != "")
            {
                htMailVal.Add("sys_problemdate", strDate);
            }
            else
            {
                htMailVal.Add("sys_problemdate", DateTime.Now.ToString());
            }
    ...
    private bool LoadReqVal()
    {
        ...
        if (dsReq != null && dsReq.Tables.Count > 0 && dsReq.Tables[0].Rows.Count > 0)
        {
            ...
            htReqVal["sys_requesttype_id"] = dr["sys_requesttype_id"].ToString();
            htReqVal["sys_problem_summary"] = dr["sys_problemsummary"].ToString();
            htReqVal["sys_problem_description"] = dr["sys_problemdesc"].ToString();
        }
    ...
    public string GetValue(string strField)
    {
        ...
        if (dsOldValue == null || dsOldValue.Tables.Count <= 0 || dsOldValue.Tables[0].Rows.Count <= 0)
        {
            ...
            if (ViewState["sys_mail_id"].ToString() != "")
            {
                ...
                if (strField == "sys_problem_description")
                {
                    if (htCtrlNode["sys_problem_description"] != null)
                    {
                        XmlElement node = (XmlElement)htCtrlNode["sys_problem_description"];
            ...
            switch (strField)
            {
                case "sys_problem_id":
                    ...
                    break;
                case "sys_loggedby":
                    str = SysDA.GetSettingValue("appautopopulateloggedbyproblem", Application);
                    if (str == "true")
                    {
                    ...
                    {
                        if (SysDA.GetSettingValue("appautopopulateloggedbyspecproblem", Application) != "")
                        {
                            if (UserDA.CheckExistUser(SysDA.GetSettingValue("appautopopulateloggedbyspecproblem", Application)))
                            {
                                strVal = SysDA.GetSettingValue("appautopopulateloggedbyspecproblem", Application);
                            }
                        }
                    }
                    break;
                case "sys_assignedto":
                    str = SysDA.GetSettingValue("appautopopulateassignedtoproblem", Application);
                    if (str == "true")
                    {
                        strVal = Session["User"].ToString();
                    }
                    ...
                    {
                        if (SysDA.GetSettingValue("appautopopulateassignedtospecproblem", Application) != "")
                        {
                            if (UserDA.CheckExistUser(SysDA.GetSettingValue("appautopopulateassignedtospecproblem", Application)))
                            {
                                strVal = SysDA.GetSettingValue("appautopopulateassignedtospecproblem", Application);
                            }
                ...
                case "sys_assignedtoanalgroup":
                    ...
                    else if (str == "spec")
                    {
                        if (SysDA.GetSettingValue("appautopopulateassignedtospecproblem", Application) != "")
                        {
                            strVal = UserDA.GetUserDefGrp(SysDA.GetSettingValue("appautopopulateassignedtospecproblem", Application));
                        }
                    }
                    break;
                case "sys_problemdate":
                    strVal = DateTime.Now.ToString();
                    break;
                case "sys_priority":
                    strVal = SysDA.GetSettingValue("appdefaultpriorityproblem", Application);
                    break;
                case "sys_impact":
                    strVal = SysDA.GetSettingValue("appdefaultimpactproblem", Application);
                    break;
                case "sys_urgency":
                    strVal = SysDA.GetSettingValue("appdefaulturgencyproblem", Application);
                    break;
                case "sys_itservice":
                    strVal = SysDA.GetSettingValue("appdefaultitserviceproblem", Application);
                    break;
                default:
                    strVal = "";
                    break;
        ...
        try
        {
            ...
            if (strField == "sys_problem_hdmins")
            {
                if (strVal == "")
                {
                    strVal = RequestDA.GetReqDuration(dr["sys_problemdate"].ToString(), DateTime.Now, listSus).ToString();
                }
            }
            else if (strField == "sys_problem_24mins")
            {
                if (strVal == "")
                {
                    strVal = RequestDA.GetReqDuration24Min(dr["sys_problemdate"].ToString(), DateTime.Now).ToString();
                }
            }
            else if (strField == "sys_problem_timespent")
            {
                string strDispFormat = SysDA.GetSettingValue("statsdurationdisplay", Application);
    ...
    protected void imgSaveEsc_Click(object sender, ImageClickEventArgs e)
    {
        ...
        ProblemDA.UpdEscalation(strProblemId, dpEsc1.Text, dpEsc2.Text, dpEsc3.Text, dpExpire.Text);
    ...
    {
        return FormDesignerBR.SaveUserProblemForm(Session["User"].ToString(), xmlForm.InnerXml);
        //return FormDesignerBR.SaveFormXML("problem", xmlForm.InnerXml);
    }
    private void AddTabs(WebTab tab)
    {
        ...
        while (nAdded < htTabNode.Count && i < byte.MaxValue)
        {
            ...
            if (node.InnerText == "sys_problem_description" || node.InnerText == "sys_problem_cause" || node.InnerText == "sys_problem_solution")
            {
                ...
                if (LayUtil.GetAttribute(node, "htmleditor") == "true")
                {
                    ...
                    if (node.InnerText == "sys_problem_description")
                    {
                        edtProblem = edt;
                    }
                    else if (node.InnerText == "sys_problem_cause")
                    {
                        edtCause = edt;
                    }
                    else if (node.InnerText == "sys_problem_solution")
                    {
                        edtSolution = edt;
                    }
            ...
            else
            {
                ...
                if (node.Name == "sys_button3")
                {
                    ...
                    {
                        btnAddTask.OnClientClick = "CheckAllowed(this);document.location='" + "TaskInfo.aspx?from=problem&field=" + node.Name + "&sys_problem_id=" + ViewState["sys_problem_id"] + "'; return false;";
                    }
                ...
                else if (node.Name == "sys_button5")
                {
                    ...
                    DataSet dsField = DataDesignDA.GetTblCol("problem");
                ...
                else if (node.Name == "sys_button6")
                {
                    ...
                    {
                        btnAttach.OnClientClick = "CheckAllowed(this);document.location='" + "ProblemAttach.aspx?field=" + node.Name + "&sys_problem_id=" + ViewState["sys_problem_id"] + "'; return false;";
                    }
                    ...
                    UpdateAttachList();
                    Session["ButtonBack"] = "ProblemInfo.aspx?field=" + node.Name + "&sys_problem_id=" + ViewState["sys_problem_id"];
                }
                else if (node.Name == "sys_button7")
                {
                    ...
                    {
                        btnAddCommnt.OnClientClick = "CheckAllowed(this);document.location='" + "ProblemCommtInfo.aspx?from=problem&field=" + node.Name + "&sys_problem_id=" + ViewState["sys_problem_id"] + "'; return false;";
                    }
                ...
                else if (node.Name == "sys_button12")
                {
                    ...
                    {
                        btnAddCallback.OnClientClick = "CheckAllowed(this);document.location='" + "ProblemCallbackInfo.aspx?from=problem&field=" + node.Name + "&sys_problem_id=" + ViewState["sys_problem_id"] + "'; return false;";
                    }
                    ...
                    Session["CallbackBack"] = "ProblemInfo.aspx?back=true&field=" + node.Name + "&sys_problem_id=" + ViewState["sys_problem_id"];
                ...
                else if (node.Name == "sys_button13")
                {
                    ...
                    {
                        btnAddCost.OnClientClick = "CheckAllowed(this);document.location='" + "CostTransn.aspx?back=Problem&field=" + node.Name + "&from=problem&sys_problem_id=" + ViewState["sys_problem_id"] + "'; return false;";
                    }
                    ...
                    Session["CostBack"] = "ProblemInfo.aspx?back=true&field=" + node.Name + "&sys_problem_id=" + ViewState["sys_problem_id"];
                }
    ...
    void btnAddTask_Click(object sender, ImageClickEventArgs e)
    {
        if (SaveProblemData())
        {
            ViewState["PostConfirmURL"] = "TaskInfo.aspx?from=problem&field=" + htTabName["task"] + "&sys_problem_id=" + ViewState["sys_problem_id"];
    ...
    void btnAttach_Click(object sender, ImageClickEventArgs e)
    {
        if (SaveProblemData())
        {
            ViewState["PostConfirmURL"] = "ProblemAttach.aspx?from=problem&field=" + htTabName["attach"] + "&sys_problem_id=" + ViewState["sys_problem_id"];
            Session["ButtonBack"] = "ProblemInfo.aspx?from=problem&field=" + htTabName["attach"] + "&sys_problem_id=" + ViewState["sys_problem_id"];
    ...
    void btnAddCallback_Click(object sender, ImageClickEventArgs e)
    {
        if (SaveProblemData())
        {
            ViewState["PostConfirmURL"] = "ProblemCallbackInfo.aspx?from=problem&field" + htTabName["callback"] + "&sys_problem_id=" + ViewState["sys_problem_id"];
    ...
    void btnAddCommnt_Click(object sender, ImageClickEventArgs e)
    {
        if (SaveProblemData())
        {
            ViewState["PostConfirmURL"] = "ProblemCommtInfo.aspx?from=problem&field=" + htTabName["comment"] + "&sys_problem_id=" + ViewState["sys_problem_id"];
    ...
    void btnAddCost_Click(object sender, ImageClickEventArgs e)
    {
        if (SaveProblemData())
        {
            ViewState["PostConfirmURL"] = "CostTransn.aspx?back=Problem&from=problem&field=" + htTabName["cost"] + "&sys_problem_id=" + ViewState["sys_problem_id"];
    ...
    void btnLink_Click(object sender, ImageClickEventArgs e)
    {
        if (SaveProblemData())
        {
            ViewState["PostConfirmURL"] = "ProblemLink.aspx?back=problem&from=problem&field=" + htTabName["link"] + "&sys_problem_id=" + ViewState["sys_problem_id"];
            Session["ButtonBack"] = "ProblemInfo.aspx?field=" + htTabName["link"] + "&sys_problem_id=" + ViewState["sys_problem_id"];
    ...
    {
        return "~/GetAttachment.aspx?fn=" + Server.UrlEncode(obj.ToString()) + "&sys_problem_id=" + ViewState["sys_problem_id"].ToString();
    }
    ...
    private void UpdateTaskList()
    {
        ...
        dgTask.DataSource = ProblemDA.GetProblemTask(ViewState["sys_problem_id"].ToString());
        dgTask.DataBind();
    ...
    private void UpdateAttachList()
    {
        ...
        string strId = ViewState["sys_problem_id"].ToString();
        dgAttach.DataSource = ProblemDA.GetProblemAttachment(strId);
        dgAttach.DataBind();
    ...
    private void UpdateCallbackList()
    {
        ...
        string strId = ViewState["sys_problem_id"].ToString();
        dgCallback.DataSource = ProblemDA.GetProblemCallback(strId);
        dgCallback.DataBind();
    ...
    private class GridCell : ITemplate
    {
        ...
        ProblemInfo page;
        public GridCell(string Field, ProblemInfo pPage)
        {
            strField = Field;
            page = pPage;
        }
    ...
    private void UpdateHistoryList(string strField)
    {
        ...
        dgHistory.DataSource = ProblemDA.GetProblemHistory(ViewState["sys_problem_id"].ToString(), strField);
        dgHistory.DataBind();
    }
    ...
    private void UpdateLinkReqList()
    {
        ...
        dgReq.DataSource = ProblemDA.GetLinkedRequest(strId);
        dgReq.DataBind();
    ...
    private void UpdateLinkChgList()
    {
        ...
        dgChange.DataSource = ProblemDA.GetLinkedChange(strId);
        dgChange.DataBind();
    }
    ...
    private void UpdateCommntList()
    {
        ...
        DataSet dsProblem = ProblemDA.GetProblemById(ViewState["sys_problem_id"].ToString());
        if (dsProblem != null && dsProblem.Tables.Count > 0 && dsProblem.Tables[0].Rows.Count > 0)
        {
            if ((htOpenStatus[dsProblem.Tables[0].Rows[0]["sys_problem_status"].ToString()] != null))
            {
                bClosed = false;
            }
        }
        ...
        if (strGrpPriv == "1")
        {
            ds = ProblemDA.GetCommentByProblemIdWithGrpRes(ViewState["sys_problem_id"].ToString(), Session["User"].ToString());
        }
        else
        {
            ds = ProblemDA.GetCommentByProblemIdUser(ViewState["sys_problem_id"].ToString(), Session["User"].ToString());
        }

        hdgCommCell.Controls.Clear();
        Control c = LayUtil.LoadControl(Page, "ProblemHdgCommt.ascx", ViewState["sys_problem_id"].ToString(), htTabName, ds, bClosed, bDelComment);
    ...
    {
        return "ReqInfo.aspx?field=" + htTabName["link"] + "&from=problem&sys_problem_id=" + ViewState["sys_problem_id"].ToString() + "&sys_request_id=" + obj.ToString();
    }
    ...
    {
        return "ChangeInfo.aspx?field=" + htTabName["link"] + "&from=problem&sys_problem_id=" + ViewState["sys_problem_id"].ToString() + "&sys_change_id=" + obj.ToString();
    }
    ...
    private void UpdateCostList()
    {
        ...
        DataSet dsTotal = CostDA.GetProblemTotalCost(ViewState["sys_problem_id"].ToString());
        ...
        dgCost.DataSource = CostDA.GetProblemCost(ViewState["sys_problem_id"].ToString()); ;
    ...
    protected void btnDel_Click(object sender, ImageClickEventArgs e)
    {
        if (textItemH.Text == "attach")
        {
            ...
            ProblemDA.DelProblemFile(ViewState["sys_problem_id"].ToString(), strFile);
        ...
        else if (textItemH.Text == "callback")
        {
            ...
            ProblemDA.DeleteProblemCallback(strId);
            dialogDelConfirm.WindowState = Infragistics.Web.UI.LayoutControls.DialogWindowState.Hidden;
            UpdateCallbackList();
        }
    ...
    public string GetCallbackUrl(object objVal)
    {
        ...
        return "ProblemCallbackInfo.aspx?field=" + htTabName["callback"] + "&sys_callback_id=" + strCallId + "&sys_problem_id=" + ViewState["sys_problem_id"].ToString();
    }
    ...
    {
        return "TaskInfo.aspx?from=problem&field=" + htTabName["task"] + "&sys_action_id=" + obj.ToString() + "&sys_problem_id=" + ViewState["sys_problem_id"];
    }

    public string GetCostTransactionUrl(object objVal)
    {
        string strCostId = objVal.ToString();
        return "CostTransn.aspx?back=Problem&field=" + htTabName["cost"] + "&sys_cost_id=" + strCostId + "&sys_problem_id=" + ViewState["sys_problem_id"];
    }
    public string GetCommntUrl(object obj)
    {
        return "ProblemCommtInfo.aspx?from=problem&field=" + htTabName["comment"] + "&inline=" + ViewState["inline"] + "&sys_comment_id=" + obj.ToString() + "&sys_problem_id=" + ViewState["sys_problem_id"];
    }
    ...
    public void CheckBusinessRule()
    {
        ...
        DataSet dsBR = BusinessRuleDA.GetEnableProblemBRList();
